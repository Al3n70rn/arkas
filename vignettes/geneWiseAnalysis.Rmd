...
ensDb<-ensDbLiteFromFasta(paste0(appSession$fastaPath,"/","Homo_sapiens.GRCh38.81.cdna_mergedWith_ncrna.fa.gz"))
ensPkg<-makeEnsDbLitePkg(ensDb,destDir=appSession$fastaPath)
repDb<-repDbLiteFromFasta(paste0(appSession$fastaPath,"/","Homo_sapiens.RepBase.20_07.merged.fa.gz"))
